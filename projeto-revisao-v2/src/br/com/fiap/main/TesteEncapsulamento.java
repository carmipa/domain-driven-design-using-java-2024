...
public class TesteEncapsulamento {
	...
	public static void main(String[] args) {
		 ...
		 * colaborador.setQuantidaHoras(Integer.parseInt(JOptionPane.
		 * showInputDialog("Quantidade de horas")));
		 * colaborador.setValorHora(Double.parseDouble(JOptionPane.
		 * showInputDialog("Valor hora R$:")));
		 * 
		 ...
		 * ; colaboradorEndereco.setNumero(Integer.parseInt(JOptionPane.showInputDialog(
		 * "Nùmero:")));
		 ...
		 * empresaEndereco.setNumero(Integer.parseInt(JOptionPane.showInputDialog(
		 * "Nùmero:"))); empresaEndereco.setCep(JOptionPane.showInputDialog("CEP:"));
		 ...
		 * "\n******************************************************************************"
		 * + "\nDADOS DA EMPRESA..............................................:" +
		 * "\nCNPJ: " + empresa.getCnpj() + "Razão social: " + empresa.getRazaoSocial()
		 * + "\nENDEREÇO DA EMPRESA..............................................:" +
